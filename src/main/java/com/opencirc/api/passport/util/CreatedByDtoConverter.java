...
public class CreatedByDtoConverter implements AttributeConverter<CreatedByDto, String> {
    ...
    /**
     * Converts a CreatedByDto object into its JSON string
     * for storage in the database.
     *
     * @param createdByDto the {@link CreatedByDto} object to convert;
     *                  may be {@code null}
     * @return the JSON string representation of the object,
     *         or null if the attribute is null
    ...
    public String convertToDatabaseColumn(CreatedByDto createdByDto) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Error serializing"
                    + " CreatedByDto to JSON", e);
        }
    }

    /**
     * Converts a JSON string retrieved from the database into a
     * CreatedByDto object.
     *
     * @param dbData the JSON string stored in the database;
     * @return the deserialized {@link CreatedByDto} object,
    ...
    public CreatedByDto convertToEntityAttribute(String dbData) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Error deserializing"
                    + " JSON to CreatedByDto", e);
        }
    }
}
